...
map.getView().fit([-669313.548218, 7423740.905011, 1536494.619599, 8966898.882496], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Límites Precisos de Bolivia</h2>';
        return titleElement;
    })(),
